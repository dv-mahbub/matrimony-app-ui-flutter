...
class InterestSentProfiles extends StatefulWidget {
  const InterestSentProfiles({super.key});

  @override
  State<InterestSentProfiles> createState() => _InterestSentProfilesState();
}

class _InterestSentProfilesState extends State<InterestSentProfiles> {
