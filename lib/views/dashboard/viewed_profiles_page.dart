...
class ViewedProfilesPage extends StatefulWidget {
  const ViewedProfilesPage({super.key});

  @override
  State<ViewedProfilesPage> createState() => _ShortlistedPageState();
}

class _ShortlistedPageState extends State<ViewedProfilesPage> {
